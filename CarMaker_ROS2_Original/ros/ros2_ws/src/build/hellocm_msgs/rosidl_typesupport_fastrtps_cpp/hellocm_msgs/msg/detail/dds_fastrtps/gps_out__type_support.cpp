...
#include "hellocm_msgs/msg/detail/gps_out__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hellocm_msgs::msg::GPSOut & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hellocm_msgs::msg::GPSOut & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const hellocm_msgs::msg::GPSOut *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hellocm_msgs::msg::GPSOut *>(
    untyped_ros_message);
...
{
  return &hellocm_msgs::msg::typesupport_fastrtps_cpp::_GPSOut__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hellocm_msgs, msg, GPSOut)() {
  return &hellocm_msgs::msg::typesupport_fastrtps_cpp::_GPSOut__handle;
}
