...
#include "hellocm_msgs/msg/detail/vehicle_control_in__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleControlIn__ros_msg_type = hellocm_msgs__msg__VehicleControlIn;
...
size_t get_serialized_size_hellocm_msgs__msg__VehicleControlIn(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleControlIn__ros_msg_type * ros_message = static_cast<const _VehicleControlIn__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VehicleControlIn__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hellocm_msgs__msg__VehicleControlIn(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hellocm_msgs
size_t max_serialized_size_hellocm_msgs__msg__VehicleControlIn(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_hellocm_msgs__msg__VehicleControlIn(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hellocm_msgs, msg, VehicleControlIn)() {
