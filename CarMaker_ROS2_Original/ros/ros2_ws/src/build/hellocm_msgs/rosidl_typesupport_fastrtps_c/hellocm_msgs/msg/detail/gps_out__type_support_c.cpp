...
#include "hellocm_msgs/msg/detail/gps_out__rosidl_typesupport_fastrtps_c.h"
...
using _GPSOut__ros_msg_type = hellocm_msgs__msg__GPSOut;
...
static uint32_t _GPSOut__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hellocm_msgs__msg__GPSOut(
...
{
  return max_serialized_size_hellocm_msgs__msg__GPSOut(
    full_bounded, 0);
}
