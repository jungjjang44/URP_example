...
bool custom_msgs__msg__object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // id
    ...
    ros_message->id = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // x
  ...
  {  // collision_status
    PyObject * field = PyObject_GetAttrString(_pymsg, "collision_status");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->collision_status = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * custom_msgs__msg__object__convert_to_py(void * raw_ros_message)
{
  ...
  {  // collision_status
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->collision_status);
    {
      int rc = PyObject_SetAttrString(_pymessage, "collision_status", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
