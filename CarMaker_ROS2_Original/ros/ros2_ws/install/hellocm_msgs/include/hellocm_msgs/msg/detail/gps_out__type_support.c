...
#include <stddef.h>
#include "hellocm_msgs/msg/detail/gps_out__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  hellocm_msgs__msg__GPSOut__init(message_memory);
}

void GPSOut__rosidl_typesupport_introspection_c__GPSOut_fini_function(void * message_memory)
{
  hellocm_msgs__msg__GPSOut__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GPSOut__rosidl_typesupport_introspection_c__GPSOut_message_member_array[7] = {
  {
    "header",  // name
    ...
    offsetof(hellocm_msgs__msg__GPSOut, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hellocm_msgs__msg__GPSOut, time),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hellocm_msgs__msg__GPSOut, cycleno),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hellocm_msgs__msg__GPSOut, synthdelay),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hellocm_msgs__msg__GPSOut, latitude),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hellocm_msgs__msg__GPSOut, longitude),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hellocm_msgs__msg__GPSOut, altitude),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GPSOut__rosidl_typesupport_introspection_c__GPSOut_message_members = {
  ...
  "GPSOut",  // message name
  7,  // number of fields
  sizeof(hellocm_msgs__msg__GPSOut),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hellocm_msgs, msg, GPSOut)() {
  GPSOut__rosidl_typesupport_introspection_c__GPSOut_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  GPSOut__rosidl_typesupport_introspection_c__GPSOut_message_member_array[1].members_ =
