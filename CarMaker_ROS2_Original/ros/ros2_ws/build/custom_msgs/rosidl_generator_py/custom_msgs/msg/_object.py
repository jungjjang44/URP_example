...
class Object(metaclass=Metaclass_Object):
    ...
    def __init__(self, **kwargs):
        ...
        self.id = kwargs.get('id', float())
        self.x = kwargs.get('x', float())
        self.y = kwargs.get('y', float())
        self.heading = kwargs.get('heading', float())
        self.collision_status = kwargs.get('collision_status', int())
    ...
    def __eq__(self, other):
        ...
        if self.heading != other.heading:
            return False
        if self.collision_status != other.collision_status:
            return False
        return True
    ...
    def id(self, value):  # noqa: A003
        if __debug__:
            assert \
                ...
                "The 'id' field must be of type 'float'"
        self._id = value
    ...
    def collision_status(self):
        """Message field 'collision_status'."""
        return self._collision_status

    @collision_status.setter
    def collision_status(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'collision_status' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'collision_status' field must be an integer in [-9223372036854775808, 9223372036854775807]"
