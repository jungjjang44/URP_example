...
bool hellocm_msgs__msg__imu_out__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hellocm_msgs.msg._imu_out.IMUOut", full_classname_dest, 32) == 0);
  }
  hellocm_msgs__msg__IMUOut * ros_message = _ros_message;
  {  // header
...
PyObject * hellocm_msgs__msg__imu_out__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hellocm_msgs.msg._imu_out");
