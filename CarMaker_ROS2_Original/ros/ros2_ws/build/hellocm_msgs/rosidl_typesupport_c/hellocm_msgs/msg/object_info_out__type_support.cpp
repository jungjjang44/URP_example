...
static const _ObjectInfoOut_type_support_symbol_names_t _ObjectInfoOut_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hellocm_msgs, msg, ObjectInfoOut)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hellocm_msgs, msg, ObjectInfoOut)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hellocm_msgs, msg, ObjectInfoOut)() {
  return &::hellocm_msgs::msg::rosidl_typesupport_c::ObjectInfoOut_message_type_support_handle;
}
