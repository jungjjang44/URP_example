...
#include "hellocm_msgs/msg/detail/vehicle_info_out__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleInfoOut__ros_msg_type = hellocm_msgs__msg__VehicleInfoOut;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VehicleInfoOut__ros_msg_type * ros_message = static_cast<const _VehicleInfoOut__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _VehicleInfoOut__ros_msg_type * ros_message = static_cast<_VehicleInfoOut__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_hellocm_msgs__msg__VehicleInfoOut(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleInfoOut__ros_msg_type * ros_message = static_cast<const _VehicleInfoOut__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VehicleInfoOut__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hellocm_msgs__msg__VehicleInfoOut(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hellocm_msgs
size_t max_serialized_size_hellocm_msgs__msg__VehicleInfoOut(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_hellocm_msgs__msg__VehicleInfoOut(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_VehicleInfoOut = {
  "hellocm_msgs::msg",
  "VehicleInfoOut",
...
static rosidl_message_type_support_t _VehicleInfoOut__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VehicleInfoOut,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hellocm_msgs, msg, VehicleInfoOut)() {
  return &_VehicleInfoOut__type_support;
}
