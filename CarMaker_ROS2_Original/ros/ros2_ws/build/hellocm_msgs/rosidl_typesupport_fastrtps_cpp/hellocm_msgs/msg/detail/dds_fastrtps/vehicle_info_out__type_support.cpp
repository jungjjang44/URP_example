...
#include "hellocm_msgs/msg/detail/vehicle_info_out__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const hellocm_msgs::msg::VehicleInfoOut *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hellocm_msgs::msg::VehicleInfoOut *>(
    untyped_ros_message);
...
{
  return &hellocm_msgs::msg::typesupport_fastrtps_cpp::_VehicleInfoOut__handle;
}
