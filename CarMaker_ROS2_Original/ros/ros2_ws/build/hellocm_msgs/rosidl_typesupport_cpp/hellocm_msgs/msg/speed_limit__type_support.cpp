...
static const _SpeedLimit_type_support_symbol_names_t _SpeedLimit_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hellocm_msgs, msg, SpeedLimit)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hellocm_msgs, msg, SpeedLimit)),
  }
};
...
{
  return &::hellocm_msgs::msg::rosidl_typesupport_cpp::SpeedLimit_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hellocm_msgs, msg, SpeedLimit)() {
  return get_message_type_support_handle<hellocm_msgs::msg::SpeedLimit>();
}
