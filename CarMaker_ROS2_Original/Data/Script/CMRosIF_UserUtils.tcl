...
namespace eval ::MyCMRosIFUtils {
    ...
    proc LaunchProc {Where InfoDict args} {
		...
		#TerminalCmd addTab default "source ros_setup.bash; ros2 run hellocm hellocm_node"       
		...
		TerminalCmd addTab default "source ros_setup.bash; ros2 launch hellocm hellocm.launch.py"
